...
**날짜**: 2026-09-03
**상태**: 승인됨 (2026-09-03). 1단계(스키마·CLI·열람·증빙 묶음) 구현 완료. 2단계 세금계산서 감지·초안 생성 대기
...
| # | 확인된 사실 | 설계에 미치는 영향 |
|---|---|---|
| 1 | **두 회사는 특수관계이고, 김동욱은 텐소의 현직 사내이사다.** 텐소 등기부(2026-02-03 발급): 이사 3인(대표이사 김철형, 사내이사 김동욱 2023-05-12 취임, 기타비상무이사 김성훈), 감사 없음(2024-03-12 사임), 자본금 12,860,000원, 성립 2018-04-23. 텐소 주주명부(2026-03-10): 김철형 12,800(49.8%), 김지원 5,120(19.9%), 윌로우 2,200(8.6%), 김류하 포함. 윌로우는 김동욱·김지원·김류하 100% 가족회사. 김철형은 윌로우의 등기 감사 | 법인세법상 부당행위계산부인 대상 거래. **용역대가의 시가 근거를 건마다 기록**해야 한다(5절). 상법 398조가 **직접** 적용된다(텐소 이사 김동욱이 지배하는 회사와 텐소의 거래): 텐소 **이사회 사전 승인(이사 3인이므로 이사회 존재, 김동욱은 특별이해관계자로 의결권 배제 → 김철형·김성훈 2인 찬성, 이사 2/3 요건 충족) + 거래 내용·절차의 공정성 + 중요사실 개시**. 상법 397조(경업·겸직) 관점에서 김동욱의 텐소 이사 겸직에 대한 윌로우 주주총회 승인 여부도 확인한다. 기본계약은 텐소 이사회 의사록과 함께 양사 서류함에 보존한다 |
...
| 시점 | 에이전트 행동 | CEO 행동 |
|---|---|---|
| 기본계약 체결(1회) | 초안(범위·단가표·프로젝트별 약정 방식·상법 398조 문구) 생성 → 서류함 draft → **텐소 이사회 의사록 자동 생성**: 법인 서류함의 텐소 의사결정 건(category `board`, 안건 "윌로우인베스트먼트와의 기본 용역계약 체결 승인(상법 398조)")으로 등록하고, 텐소 정관 이사회 조항 + 프로필(이사 3인)에서 소집 생략 동의·출석·특별이해관계자 배제(김동욱)·찬성 2/3 요건을 계산해 `minutes_board`(이사회 의사록)와 `resolution_board`를 렌더한다. 개별 업무약정도 기준을 벗어나면 같은 방식으로 이사회 건이 자동 생성된다 | "확인" → 인감 이미지 날인로 확정. 텐소 정관 미등록 시 정관 파일 제공 |
...
1. ~~텐소 이사 수~~ 2026-09-03 텐소 등기부(2026-02-03)·주주명부(2026-03-10) 수령. 이사 3인 → 텐소 **이사회** 승인, 김동욱 의결권 배제. **추가 확인: 김동욱의 텐소 사내이사 임기(2023-05-12 취임, 3년)가 2026-05-12에 만료되었는데 중임 등기가 있었는지** — 2026-02-03 이후 등기부 재발급으로 확인. 만료 후 퇴임 상태면 398조 대신 주요주주 특수관계 경로로 문구가 바뀐다.
...
7. ~~텐소 정관 필요~~ 2026-09-03 수령(2023-08-22 시행본, 별첨 1·2). 이사회 규칙 확정: 제34조 회일 7일 전 통지·이사 및 감사 전원 동의 시 생략, 제35조 이사 과반 출석·출석 과반·특별이해관계자 의결권 배제, 제36조 의사록에 안건·경과·결과·반대자와 이유 기재, 출석 이사(감사 없음) 기명날인. 제33조 임원 보수는 주주총회. **불일치 발견**: 정관 제7조 1주 금액이 5,000원인데 등기는 2022-04-03 액면분할로 500원. 액면분할 당시 개정 정관이 있는지 확인하고 없으면 정관 정비 안건(시드 액션으로 등록).
