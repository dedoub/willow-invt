...
const TOOL_PERMISSIONS: Record<string, ToolPermission> = {
  ...
  ryuha_list_notes:         { roles: ['admin', 'editor', 'viewer'], scopes: ['ryuha:read'] },
  ryuha_create_note:        { roles: ['admin', 'editor'], scopes: ['ryuha:write'] },
  ryuha_update_note:        { roles: ['admin', 'editor'], scopes: ['ryuha:write'] },
  ryuha_delete_note:        { roles: ['admin', 'editor'], scopes: ['ryuha:write'] },
