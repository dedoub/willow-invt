export const ko = {
  ...
  gmail: {
    ...
    scheduleDate: '발송 날짜',
    scheduleTime: '발송 시간',
    scheduleFailed: '이메일 예약에 실패했습니다',
    scheduleSuccess: '이메일이 예약되었습니다',
    errorNoScheduleTime: '발송 날짜와 시간을 입력하세요',
    schedulePast: '과거 시간은 예약할 수 없습니다',
