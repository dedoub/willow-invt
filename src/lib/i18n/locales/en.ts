export const en = {
  ...
  etf: {
    ...
    etcDescription: 'Korean Sponsor Products',
    totalAum: 'Total AUM',
  ...
  gmail: {
    ...
    scheduleFailed: 'Failed to schedule email',
    scheduleSuccess: 'Email scheduled successfully',
    errorNoScheduleTime: 'Please select a date and time',
    schedulePast: 'Cannot schedule in the past',
  ...
  tensoftworks: {
    ...
    sections: {
      ...
      activity: 'Activity',
      todos: 'Todos',
      lastTodoUpdate: 'Last Todo Update',
    },
    // Priority
    priority: {
      critical: 'Critical',
