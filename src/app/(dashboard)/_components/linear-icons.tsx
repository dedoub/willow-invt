...
const paths: Record<string, string> = {
  ...
  coin: 'M12 21a9 9 0 100-18 9 9 0 000 18M12 7v10M14.5 9.3c-.6-.8-1.5-1.3-2.5-1.3-1.4 0-2.5.9-2.5 2s1.1 2 2.5 2 2.5.9 2.5 2-1.1 2-2.5 2c-1 0-1.9-.5-2.5-1.3',
  ...
  // 필기 도구 바 (2026-09-13) — stroke 1.5~2.0 규칙에 맞춘 선 아이콘.
  // 지우개: 기울어진 몸통 + 바닥선. 지우개 도구와 '전체 지우기'(trash)를 갈라 쓴다.
  eraser: 'M8 21H5l-2-2a2 2 0 010-3L14 5a2 2 0 013 0l4 4a2 2 0 010 3l-9 9M8 21h12M9 10l5 5',
  undo: 'M9 14L4 9l5-5M4 9h11a5 5 0 010 10h-4',
  redo: 'M15 14l5-5-5-5M20 9H9a5 5 0 000 10h4',
  // 끄는 손잡이 — 누르는 단추와 갈라 두는 자리라 점 여섯.
  grip: 'M9 5h.01M9 12h.01M9 19h.01M15 5h.01M15 12h.01M15 19h.01',
  // 도구 바를 위로 붙이기 / 다시 띄우기
  dockTop: 'M4 5h16v14H4zM4 9h16',
  floatTools: 'M4 5h16v14H4zM12 12h8v7h-8z',
  logOut: 'M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4M16 17l5-5-5-5M21 12H9',
  arrowUp: 'M12 19V5M5 12l7-7 7 7',
  arrowDown: 'M12 5v14M19 12l-7 7-7-7',
  download: 'M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3',
  panelLeft: 'M3 4h18v16H3zM9 4v16',
  // 전체화면 들어가기 / 나오기 — 네 모서리가 밖으로 벌어지거나 안으로 접힌다
  ...
  // 고리 두 개. 원본(24 그리드의 3~21)은 다른 아이콘보다 화면을 꽉 채워 혼자 커 보인다 —
  // 중심(12,12) 기준 0.8 로 줄여 그렸다(2026-09-11).
  link: 'M10.4 12.8a4 4 0 006.03.43l2.4-2.4a4 4 0 00-5.66-5.66l-1.38 1.37M13.6 11.2a4 4 0 00-6.03-.43l-2.4 2.4a4 4 0 005.66 5.66l1.37-1.37',
  // 자물쇠 — 잠김은 고리가 몸통에 닿아 있고, 열림은 한쪽이 떨어져 있다.
  lock: 'M5 11h14v10H5zM8 11V7a4 4 0 018 0v4',
  unlock: 'M5 11h14v10H5zM8 11V7a4 4 0 017.4-2',
}
