          ...
          return (
            <div key={theme}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
                ...
                {hasQuotes && groupValKrw > 0 && (
                  <span style={{ fontSize: `calc(${t.type.control}px * var(--fz, 1))`, fontWeight: t.weight.medium, color: pnlColor(groupPnl), marginLeft: 'auto' }}>
                    ...
                    <div key={sub ?? '__flat'} style={{ display: 'flex', flexDirection: 'column', gap: 4 }} data-sub-group="1">
                      {sub && sc && (
                        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 2 }}>
                          ...
                          {hasQuotes && subValKrw > 0 && (
                            <span style={{ fontSize: `calc(${t.type.helper}px * var(--fz, 1))`, fontWeight: t.weight.medium, color: pnlColor(subPnl), marginLeft: 'auto' }}>
                  ...
                  return (
                    <div key={h.ticker} style={{
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2px 16px', marginTop: 4, fontSize: `calc(${t.type.control}px * var(--fz, 1))` }}>
                        ...
                        {h.currentPrice > 0 ? (
                          <span style={{ color: t.neutrals.muted }}>
                            <span style={{ fontSize: `calc(${t.type.tableCell}px * var(--fz, 1))`, color: t.neutrals.subtle }}>현재 </span>
                            {fmtPrice(h.currentPrice, h.currency)}
                          </span>
                        ) : <span style={{ color: t.neutrals.subtle }}>-</span>}

                        <span style={{ color: t.neutrals.muted }}>
                          <span style={{ fontSize: `calc(${t.type.tableCell}px * var(--fz, 1))`, color: t.neutrals.subtle }}>투자 </span>
                          {fmtAmount(dInvested, dCur)}
                        </span>
                        {h.currentPrice > 0 ? (
                          <span style={{ fontWeight: t.weight.medium }}>
                            <span style={{ fontSize: `calc(${t.type.tableCell}px * var(--fz, 1))`, color: t.neutrals.subtle, fontWeight: t.weight.regular }}>평가 </span>
                        ...
                        {h.currentPrice > 0 && (
                          <>
                            ...
                            <span style={{ fontWeight: t.weight.medium, color: pnlColor(dPnl) }}>
                              <span style={{ fontSize: `calc(${t.type.tableCell}px * var(--fz, 1))`, color: t.neutrals.subtle, fontWeight: t.weight.regular }}>누적 </span>
