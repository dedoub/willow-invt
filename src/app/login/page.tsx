...
export default function LoginPage() {
  ...
  if (authLoading || isAuthenticated) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-brand-900 to-slate-900" style={{ fontFamily: '"Pretendard Variable", Pretendard, system-ui, "Segoe UI", Roboto, "Apple SD Gothic Neo", "Malgun Gothic", sans-serif' }}>
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-slate-900 via-brand-900 to-slate-900" style={{ fontFamily: '"Pretendard Variable", Pretendard, system-ui, "Segoe UI", Roboto, "Apple SD Gothic Neo", "Malgun Gothic", sans-serif' }}>
      {/* Left Panel - Branding */}
