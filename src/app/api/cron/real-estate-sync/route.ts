...
// --- Data Mapping ---
// 압구정 현대: MOLIT 원시 아파트명(분리·다양)을 네이버 호가·re_complexes 추적명과
// 일치하는 통합 3개 이름으로 정규화. dong(umdNm='압구정동') 스코핑으로 오매핑 방지.
// (scripts/real-estate-pipeline.ts 와 동일 규칙 — 두 수집 경로 정합 유지)
