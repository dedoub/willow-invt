        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-white/10">
            <div className="text-center mb-8">
              ...
              <p className="text-brand-100/70 mt-2">{t.auth.signup.subtitle}</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Name */}
              <div className="space-y-2">
                <Label htmlFor="name" className="text-brand-100">
                  {t.auth.signup.name}
                </Label>
                <div className="relative">
                  <User className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-brand-300/50" />
                  <Input
                    id="name"
                    type="text"
              ...
              {/* Signup Code */}
              <div className="space-y-2">
                <Label htmlFor="signupCode" className="text-brand-100">
                  {t.auth.signup.signupCode} <span className="text-red-400">*</span>
                </Label>
                <div className="relative">
                  <KeyRound className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-brand-300/50" />
                  <Input
                    id="signupCode"
                    type="password"
